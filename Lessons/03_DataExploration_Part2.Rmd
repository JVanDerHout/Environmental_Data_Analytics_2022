...
```{r, fig.height = 3, fig.width = 4}
#discharge mean historgram with default binwidths
...
> Answer: 
Bar plots are for categorical varaibles. 
Historgrams are for continuous numerical values. 
...
Box and whisker are distributions of values for continuous numerical variables
Violin represents density distributions
Scatterplots are meant to be used when you have a continuous and numerical variable
## Ending discussion
